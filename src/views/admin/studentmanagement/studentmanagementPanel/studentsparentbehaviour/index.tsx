...
import StudentsParentBehaviourList from "./components";

const StudentsParentsBehaviour = () => {
  return (
    <>
      ...
      <StudentsParentBehaviourList tableData={[1,1,1,1,1]} tableName="Student's Parents & Behaviour List" />
    </>
  );
};

export default StudentsParentsBehaviour;
