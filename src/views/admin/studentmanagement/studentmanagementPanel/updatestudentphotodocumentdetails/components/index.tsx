...
function StudentPhotoDocumentUpdateList(props: {
  fieldData: any;
  tableData: any;
  tableName?: string;
}) {
...
export default StudentPhotoDocumentUpdateList;
