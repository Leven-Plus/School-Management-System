...
import UpdateSiblingDetailsList from "./components"
...
const UpdateSiblingDetails = () => {
  return (
    <>
      ...
      <UpdateSiblingDetailsList tableData={[1,1,1,1,1]} tableName="Students List" />
    </>
  )
}

export default UpdateSiblingDetails