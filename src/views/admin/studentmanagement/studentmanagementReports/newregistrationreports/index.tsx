...
import NewRegistrationReportsList from "./components/NewRegistrationReportsList";

const NewRegistrationReports = () => {
  return (
    <>
      <Card className="rounded-xl bg-white dark:bg-navy-800 p-5 mb-5">
      <h2 className="text-2xl font-bold dark:text-white">Find Registration</h2>
      ...
      <Card className="rounded-xl bg-white dark:bg-navy-800 p-5 mb-5">
        ...
        <NewRegistrationReportsList
          tableData={[1, 1, 1, 1, 1, 1, 1]}
          tableName="NEW REGISTRATION INFO"
        />
      </Card>
    </>
  );
...
export default NewRegistrationReports;
