...
import UpdateEmployeeSalaryInfoList from './components/UpdateEmployeeSalaryInfoList';

type option = {
    [_: string]: boolean;
  };

const UpdateEmployeeSalaryInfo = () => {
    const [optionList, setOptionList] = useState<option>({
        "Employee Pancard Number": false,
        "Employee PF Number": false,
        "Employee Bank Name": false,
        "Account Number": false,
        "Bank IFSC Code": false,
        "Basic Salary": false,
        "Other Profile": false,
        "Other Profile Salary": false,
        "HRA Amount": false,
        "DA Amount":false,
        "Allownace Amount":false,
        "Other Wages Amount":false,
        "PF Amount":false,
        "TDS Amount":false,
        "ESIC Amount":false,
        "Professional Tax":false,
      });
  return (
    <>
        ...
        <div className="mt-3 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-4">
          ...
          <fieldset className="border-[2px] p-2 rounded-lg dark:border-navy-200">
            ...
            <select
              ...
              required
            >
              <option value="Select Class">Register 1</option>
            </select>
          </fieldset>
...
export default UpdateEmployeeSalaryInfo