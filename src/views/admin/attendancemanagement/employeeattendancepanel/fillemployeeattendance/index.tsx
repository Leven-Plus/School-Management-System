        ...
        <div className="mt-3 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-4">
          ...
          <fieldset className="border-[2px] p-2 rounded-lg dark:border-navy-200">
            <legend
              ...
              className="text-xl text-navy-700 dark:text-white px-1.5"
            >
              Select Employee Attendance Register<span className="text-red-500">*</span>
            </legend>
            <select
              name="classXyz"
              id="classXyz"
              ...
              required
            >
              <option value="Select Section">Select Employee Attendance Register</option>
            </select>
          </fieldset>
          <fieldset className="border-[2px] p-2 rounded-lg dark:border-navy-200">
            <legend
...
export default FillEmployeeAttendance;
