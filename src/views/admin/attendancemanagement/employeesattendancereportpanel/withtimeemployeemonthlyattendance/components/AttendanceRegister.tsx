    ...
    >
      <header className="mb-5">
        ...
        <div className="relative flex items-center justify-between pt-4">
          ...
          <h2 className="text-2xl font-bold dark:text-white text-center pl-2">
      ...
      <Table tableExtras="w-full border-2">
        <THeade>
          <Tr extras="border-b-2">
            <Th
              textalign="center"
              extras="text-[0.7em] border-r-2 w-[2%] py-0 px-2"
            >
              S No.
            </Th>
            <Th textalign="center" extras="text-[0.7em] border-r-2 w-[4%] py-0">
              Employee ID
            </Th>
            <Th
              textalign="center"
              extras="text-[0.7em] border-r-2 w-[10%] py-0"
            >
              Employee Name
            </Th>
            <Th
            ...
            <Th textalign="center" extras="text-[0.7em] border-r-2 py-0 w-[6%]">
            ...
            {Array(30)
              ...
              .map((r: any, r_i: number) => {
                return (
                  <Th
                    textalign="center"
                    extras="text-[0.7em] border-r-2 py-0 w-[1.4%]"
                    key={r}
                  >
                    {r_i + 1}
                  </Th>
            ...
            <Th textalign="center" extras="text-[0.7em] border-r-2 py-0 w-[4%]">
              Total Present
            </Th>
            <Th textalign="center" extras="text-[0.7em] border-r-2 py-0 w-[4%]">
              Total Absent
            ...
            <Th textalign="center" extras="text-[0.7em] py-0 w-[4%]">
              Total Not Mark
            </Th>
          </Tr>
        </THeade>
