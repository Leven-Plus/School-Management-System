...
interface DayWiseEmployeeMonthlyAttendanceProps {
  studentName?: string;
  attendance?: number;
}

const DayWiseEmployeeMonthlyAttendance: React.FC<
  DayWiseEmployeeMonthlyAttendanceProps
> = () => {
  return (
    <>
...
export default DayWiseEmployeeMonthlyAttendance;
