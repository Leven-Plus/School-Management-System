      ...
      <Table tableExtras="w-full border-2">
        <THeade>
          <Tr extras="border-b-2">
            ...
            <Th textalign="center" extras="text-[0.7em] border-r-2 w-[4%] py-0">Employee ID</Th>
            <Th textalign="center" extras="text-[0.7em] border-r-2 w-[10%] py-0">Employee Name</Th>
            <Th textalign="center" extras="text-[0.7em] border-r-2 w-[10%] py-0">Employee Department</Th>
            <Th textalign="center" extras="text-[0.7em] border-r-2 py-0 w-[6%]">Employee Designation</Th>
            {Array(30)
              .fill("")
