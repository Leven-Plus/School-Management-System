...
const EmployeeAttendanceEmployeeWise: React.FC = () => {
  return (
    <>
      ...
      <AttendanceRegister tableData={Array(10).fill(0)} tableName="Employee Attendance Report" />
    </>
  );
};

export default EmployeeAttendanceEmployeeWise;
