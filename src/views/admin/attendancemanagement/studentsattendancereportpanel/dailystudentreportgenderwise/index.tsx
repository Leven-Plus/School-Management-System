...
import TotalStudentStateGenderWiseTable from "./components/TotalStudentStateGenderWiseTable";

interface StudentAttendanceReportGenderWiseProps {
  // Add any required props here
}

const StudentAttendanceReportGenderWise: React.FC<
  StudentAttendanceReportGenderWiseProps
> = () => {
  return (
    <>
      ...
      <TotalStudentStateGenderWiseTable
        tableData={Array(10).fill(1)}
        tableName="Class Wise Students Attendance Register (Gender Wise)"
      />
    </>
  );
};

export default StudentAttendanceReportGenderWise;
