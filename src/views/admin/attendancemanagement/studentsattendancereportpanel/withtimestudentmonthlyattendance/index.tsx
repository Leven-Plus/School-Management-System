...
interface DayWiseWithTimeStudentMonthlyAttendanceProps {
  studentName?: string;
  attendance?: number;
}

const DayWiseWithTimeStudentMonthlyAttendance: React.FC<
  DayWiseWithTimeStudentMonthlyAttendanceProps
> = () => {
  return (
    <>
    ...
    <AttendanceRegister tableData={Array(20).fill("1")} tableName="Class Wise Student Attendance Report" />
    </>
  );
};

export default DayWiseWithTimeStudentMonthlyAttendance;
