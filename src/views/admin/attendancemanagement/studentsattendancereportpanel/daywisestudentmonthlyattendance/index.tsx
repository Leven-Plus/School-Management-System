...
interface DayWiseStudentMonthlyAttendanceProps {
  studentName?: string;
  attendance?: number;
}

const DayWiseStudentMonthlyAttendance: React.FC<
  DayWiseStudentMonthlyAttendanceProps
> = () => {
  return (
    <>
...
export default DayWiseStudentMonthlyAttendance;
