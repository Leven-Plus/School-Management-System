...
import MotherIdGenerateList from './components/MotherIdGenerateList';

const GenerateMotherID = () => {
  return (
    ...
    <MotherIdGenerateList tableData={[1,1,1,1,1,1,1]} tableName="Students ID" />
...
export default GenerateMotherID;