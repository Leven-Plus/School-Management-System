...
import ParentsCombineIdGenerateList from "./components/ParentsCombineIdGenerateList"

const GenerateParentsCombineID = () => {
  return (
    ...
    <ParentsCombineIdGenerateList tableData={[1,1,1,1,1,1,1]} tableName="Students ID" />
...
export default GenerateParentsCombineID