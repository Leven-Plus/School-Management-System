...
import FatherIdGenerateList from "./components/FatherIdGenerateList"

const GenerateFatherID = () => {
  return (
    ...
    <FatherIdGenerateList tableData={[1,1,1,1,1,1,1]} tableName="Students ID" />
...
export default GenerateFatherID