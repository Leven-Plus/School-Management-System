...
function EmployeeIdGenerateList(props: { tableData: any; tableName?: string }) {
            ...
            return (
              <Tr key={r}>
                ...
                <Td extras="flex gap-[10px] justify-center items-center">
                  <Checkbox id={`select-student${r_i}`} />
                  <label htmlFor={`select-student${r_i}`}>Select Employee</label>
                </Td>
              </Tr>
            );
          })}
...
export default EmployeeIdGenerateList;
