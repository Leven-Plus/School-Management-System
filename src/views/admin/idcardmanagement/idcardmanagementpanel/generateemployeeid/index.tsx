...
import EmployeeIdGenerateList from "./components/EmployeeIdGenerateList";
...
const GenerateEmployeeID = () => {
  return (
    ...
    <div className="mt-3 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-4 mb-5">
    ...
    <EmployeeIdGenerateList tableData={[1,1,1,1,1,1,1]} tableName="Students ID" />
