...
import StudentHostelIdGenerateList from './components/StudentHostelIdGenerateList'

const GenerateStudentHostelID = () => {
  return (
    ...
    <StudentHostelIdGenerateList tableData={[1,1,1,1,1,1,1]} tableName="Students ID" />
...
export default GenerateStudentHostelID